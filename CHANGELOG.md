...
## [12.0.0](https://github.com/eldios/codecompanion.nvim/compare/v13.2.1...v12.0.0) (2025-03-06)
...
* **adapters:** add Hugging Face adapter ([#527](https://github.com/eldios/codecompanion.nvim/issues/527)) ([48747c4](https://github.com/eldios/codecompanion.nvim/commit/48747c4e36eb0a3f44d6d9e55f8089b9e27cacfc))
...
* **adapters:** update `copilot` and `openai` adapters for o1 models ([c7ba92a](https://github.com/eldios/codecompanion.nvim/commit/c7ba92ad367939e94bfa23df7e3eb1bc74909348))
...
* **chat:** :sparkles: can pin buffers and files to requests ([fc8ee3a](https://github.com/eldios/codecompanion.nvim/commit/fc8ee3a085a44d0ef0111be0499f6552d7dbe865))
...
* **chat:** add `CodeCompanionChatOpened` event ([fdfc640](https://github.com/eldios/codecompanion.nvim/commit/fdfc640f638de7e44580c75882b81cc6dd99b950))
* **chat:** adding to chat initializes buffer if needed ([#567](https://github.com/eldios/codecompanion.nvim/issues/567)) ([8c82ced](https://github.com/eldios/codecompanion.nvim/commit/8c82cedc3d70255ec6ea0fdb348b3e931c435fba))
* **chat:** can delete references ([367eccc](https://github.com/eldios/codecompanion.nvim/commit/367eccc7cc57edcc249bae850ac4ccdf599a060c))
* **chat:** can delete references ([c0b8c25](https://github.com/eldios/codecompanion.nvim/commit/c0b8c2522c20b8369201132a4ce953f3cdf7b5e2))
* **chat:** customize split position ([#556](https://github.com/eldios/codecompanion.nvim/issues/556)) ([7374192](https://github.com/eldios/codecompanion.nvim/commit/73741920097f36c762bb8fe1f4de6617389e2d4c))
...
* **copilot:** add token count ([4fd26a6](https://github.com/eldios/codecompanion.nvim/commit/4fd26a6fd9bc6aa4e88176350a05ff7e16b3a789))
...
* **slash_cmd:** notify if no terminal buffer is found ([3687b88](https://github.com/eldios/codecompanion.nvim/commit/3687b8807746700851f13a373ad6ead04bb082bd))
...
* [#542](https://github.com/eldios/codecompanion.nvim/issues/542) use vim.treesitter instead of nvim-treesitter. ([#543](https://github.com/eldios/codecompanion.nvim/issues/543)) ([b741490](https://github.com/eldios/codecompanion.nvim/commit/b741490066c0129554300e493f27767b760ffa16))
...
* **adapters:** [#528](https://github.com/eldios/codecompanion.nvim/issues/528) Gemini adapter fails if system prompt is removed ([7ca4364](https://github.com/eldios/codecompanion.nvim/commit/7ca43642376d7768a3f2ecea2cd99ae9a792451a))
* **adapters:** [#560](https://github.com/eldios/codecompanion.nvim/issues/560) nil url in openai_compatible adpater ([5cc2693](https://github.com/eldios/codecompanion.nvim/commit/5cc26934b0732dda03d311195e6d3f357e4f4a0c))
...
* **adapters:** further openai_compatible fixes ([a84f6ff](https://github.com/eldios/codecompanion.nvim/commit/a84f6ff4be745bcff7d69af96fdbdae2465a33a2))
* **adapters:** gemini-2.0-flash-exp inline strategy ([#568](https://github.com/eldios/codecompanion.nvim/issues/568)) ([a9faa69](https://github.com/eldios/codecompanion.nvim/commit/a9faa69d3bf8308b78deab97292af2acc57d2f87))
...
* **adapters:** openai_compatible ([0d1388f](https://github.com/eldios/codecompanion.nvim/commit/0d1388f7409f06e96ef2a7eadfa76c1dcfb74648))
...
* allow for multiple completions in a single line ([3516e46](https://github.com/eldios/codecompanion.nvim/commit/3516e46a62ebb151e6fa0afe4ac631432994cc3a))
* **blink:** [#587](https://github.com/eldios/codecompanion.nvim/issues/587) slash commands ([1b8ab18](https://github.com/eldios/codecompanion.nvim/commit/1b8ab18cd0be76f13d13e6deaa56e6c33dce5a23))
* **blink:** slash commands leaving brackes in chat buffer ([820bc52](https://github.com/eldios/codecompanion.nvim/commit/820bc52c7b4a5a494773a3aa4e25e9e36659e378))
...
* **chat:** show documentation for blink.cmp ([f41dbab](https://github.com/eldios/codecompanion.nvim/commit/f41dbab850572b290e37e0b52244b8ccb9699870))
...
* **gemini:** remove cycle from system prompt ([d6b95bb](https://github.com/eldios/codecompanion.nvim/commit/d6b95bb6cbf074e2e431c6a7f9acdd1af7cc9397))
...
* **inline:** [#531](https://github.com/eldios/codecompanion.nvim/issues/531) inline edits in c++ buffers ([73e8ea5](https://github.com/eldios/codecompanion.nvim/commit/73e8ea561e81cce3b9c75d825b8294e0a82fc4e9))
...
* **slash_commands:** prompt library now works with blink.cmp ([1027f47](https://github.com/eldios/codecompanion.nvim/commit/1027f47c6c583a6b6592ae60a8008d780517792a))
...
* **workflow:** can auto_submit the first prompt ([86f96d5](https://github.com/eldios/codecompanion.nvim/commit/86f96d5419915b0711afbc93d948a3312bfc25b6))
* **workflows:** wrap in `vim.schedule` for performance ([f0f6e26](https://github.com/eldios/codecompanion.nvim/commit/f0f6e260a98c5ffe6ff6257227d1f429a4ecb07c))
...
* **agents:** agents are now in `strategies.chat.agents` ([3f437a6](https://github.com/eldios/codecompanion.nvim/commit/3f437a62d55ad6efe14a4af2ffdc4e474696852a))
